...
namespace CarbonWise.BuildingBlocks.Infrastructure.Services.Consumption
{
    public class ConsumptionDataService : IConsumptionDataService
    {
        ...
        {
            var data = await GetConsumptionDataAsync(consumptionType, startDate, endDate);
            ...
            return GenerateExcel(data.ToList(), consumptionType, includeGraphs);
        }
        ...
        private byte[] GenerateExcel(List<ConsumptionDataDto> data, string consumptionType, bool includeGraphs)
        {

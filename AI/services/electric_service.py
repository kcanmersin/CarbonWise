...
class ElectricPredictionService:
    """Elektrik tüketimi tahmin servisi"""
    ...
    def __init__(self, model_type="ensemble"):
        ...
        # Model seçimi
        if model_type == "rf":
            self.model = ElectricRandomForestModel()
        elif model_type == "xgb":
            self.model = ElectricXGBoostModel()
        elif model_type == "gb":
            self.model = ElectricGradientBoostingModel()
        elif model_type == "ensemble":
            self.model = ElectricEnsembleModel()
        else:
        ...
        self.model_path = os.path.join(self.models_dir, f"electric_{model_type}.joblib")
        self.data_path = os.path.join(self.models_dir, f"electric_data.joblib")
